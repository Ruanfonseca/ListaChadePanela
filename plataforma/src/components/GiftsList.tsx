...
const GiftsList = () => {
  ...
  const finalizeGiftConfirmation = async () => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_PROD}/gifts/${giftId}/choose`,
        {
          method: "PATCH",
  ...
  const printChosenGifts = () => {
    ...
    const printContent = chosenGifts
      .map((gift) => `${gift.name} - Escolhido por: ${gift.chosenBy}`)
      .join("\n");
      ...
      <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-x-10 gap-y-6 text-cha-brown">
              <div className="flex items-center gap-3 min-w-[250px] justify-center">
                ...
                <div className="text-sm text-center md:text-left">
                  ...
                  <div>
                    R. Cândida Rosa, 148, Campo Grande, Rio de Janeiro,
                    23017-340(rua do antigo sítio alegre)
                  </div>
        ...
        {/* <div className="bg-cha-brown text-white p-6 rounded-2xl mb-8 shadow-lg">
          ...
          <p className="mb-4">
            ...
            na escolha do presente, vamos gostar muito!
          </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {(selectedCategory === "Indisponíveis"
                    ...
                    <div key={gift.id} className="relative">
                      <GiftCard gift={gift} onChoose={handleChooseGift} />
              ...
              {loadingUnavailable ? (
                ...
                <div className="space-y-3">
                  {(selectedCategory === "Disponíveis"
                    ...
                    <div
                      key={gift.id}
                      className="bg-cha-beige/50 p-3 rounded-lg border border-cha-sage-dark/20"
                    >
                      <div className="flex items-center gap-3">
                        <div className="text-2xl">{gift.image}</div>
                        <div className="flex-1">
                          <h4 className="font-semibold text-cha-brown">
                            {gift.name}
                          </h4>
                          <p className="text-sm text-cha-sage-dark">
                            Escolhido por: {gift.chosenBy}
                          </p>
                          {gift.chosenByWhatsApp && (
                            <p className="text-xs text-cha-brown">
                              WhatsApp: (021) ----- ----
                            </p>
                          )}
                        </div>
